...
public class URLHelper extends AsyncTask<String, Void, String[]>{
	...
	public URLHelper(BaseActivity activity, String packageName) {
		super();
...
//http://5.9.94.2:9444/request?pub_id=PUB_ID&platform=android&tag=TAG&app_id=A
	...
	public void pingDownload() {
		...
		URLHelperFactory.createInstance().execute(url,ACTION_GET_INSTALL);
		
	}
	
	public void pingUnpack(){
		String url = getUnpackURL();
		URLHelperFactory.createInstance().execute(url,ACTION_GET_CONVERTION);
	}
